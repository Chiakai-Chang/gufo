#!/usr/bin/env python3
"""strix-inspect — validate a safetensors snapshot, write source-manifest.json.

Implements the Safetensors Source Contract in docs/QUANTIZATION.md.

Usage:
  strix-inspect --source DIR [--out manifest.json] [--json]
"""
import sys
import os
import json
...
def main(argv=None):
    ap = argparse.ArgumentParser(prog="strix-inspect")
