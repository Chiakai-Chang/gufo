#ifndef STRIX_MODELS_QWEN3_TTS_HIP_SPEAKER_ENCODER_RUNTIME_HPP_
#define STRIX_MODELS_QWEN3_TTS_HIP_SPEAKER_ENCODER_RUNTIME_HPP_
...
#endif  // STRIX_MODELS_QWEN3_TTS_HIP_SPEAKER_ENCODER_RUNTIME_HPP_
