...
#pragma unroll
        ...
        scales[b] = e;
        const float inv_s = (amax == 0.0f) ? 0.0f : __frcp_rn(ds4_ggml_hip_e8m0_to_fp32(e));

        // Fallback: manual FP4 conversion using LUT
        const uint8_t q_val = ds4_ggml_hip_float_to_fp4_e2m1(xi, inv_s);
...
void ds4_quantize_row_q8_1_hip(
...
void ds4_quantize_mmq_q8_1_hip(
        const float * x, const int32_t * ids, void * vy, const ggml_type type_src0,
        const int64_t ne00, const int64_t s01, const int64_t s02, const int64_t s03,
        const int64_t ne0, const int64_t ne1, const int64_t ne2, const int64_t ne3, hipStream_t stream) {
