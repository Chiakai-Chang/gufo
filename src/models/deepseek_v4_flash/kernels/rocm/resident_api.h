...
int ds4_gpu_release_model_staging(void);
...
int ds4_gpu_hc_expand_split_tensor(ds4_gpu_tensor* out_hc,
                                   ...
                                   const ds4_gpu_tensor* split, uint32_t n_embd,
                                   uint32_t n_hc);
...
int ds4_gpu_hc_norm_mix_split_weighted_sum_tensor(
    ds4_gpu_tensor* out, ds4_gpu_tensor* mix, ds4_gpu_tensor* split,
    const ds4_gpu_tensor* residual_hc, const void* model_map,
    uint64_t model_size, uint64_t mix_weight_offset, uint64_t scale_offset,
    uint64_t base_offset, uint32_t n_embd, uint32_t n_hc, uint32_t n_rows,
...
int ds4_gpu_indexer_scores_decode_batch_tensor(ds4_gpu_tensor *scores, const ds4_gpu_tensor *q, const ds4_gpu_tensor *weights, const ds4_gpu_tensor *index_comp, uint32_t n_comp, uint32_t n_tokens, uint32_t pos0, uint32_t n_head, uint32_t head_dim, uint32_t ratio, float scale, ds4_gpu_tensor *score_scratch);
int ds4_gpu_indexer_scores_prefill_tensor(ds4_gpu_tensor *scores, const ds4_gpu_tensor *q, const ds4_gpu_tensor *weights, const ds4_gpu_tensor *index_comp, uint32_t n_comp, uint32_t n_tokens, uint32_t n_head, uint32_t head_dim, uint32_t ratio, float scale, ds4_gpu_tensor *score_scratch);
...
int ds4_gpu_routed_moe_batch_tensor(
    ...
    ds4_gpu_tensor* mid, ds4_gpu_tensor* experts, const void* model_map,
...
int ds4_gpu_attention_noncausal_raw_batch_heads_tensor(
    ...
    const ds4_gpu_tensor* raw_kv, uint32_t n_tokens, uint32_t n_raw,
    uint32_t raw_cap, uint32_t raw_start, uint32_t n_head, uint32_t head_dim);
...
int ds4_gpu_dspark_candidates_tensor(
