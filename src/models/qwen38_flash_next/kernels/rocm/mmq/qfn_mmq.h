...
// One-token Q4_K/Q5_K gate/up projection with the SwiGLU result in out.
int qfn_mmq_moe_gated_decode(int weight_type, const void* gate, const void* up,
                             const float* x, const int32_t* ids, float* out,
                             int m, int k, int experts, int experts_used,
                             hipStream_t stream);
