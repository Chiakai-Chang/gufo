...
bool qfn_mmq_q2_K_moe_d2r_available(int cc);
bool qfn_mmq_iq2_xxs_moe_d2r_available(int cc);

size_t qfn_mmq_q2_K_moe_d2r_scratch_bytes(int64_t ncols_max, int n_experts);
size_t qfn_mmq_iq2_xxs_moe_d2r_pair_scratch_bytes(int64_t ncols_max, int n_experts);
size_t qfn_mmq_iq2_xxs_moe_d2r_fused_scratch_bytes(
...
bool qfn_mmq_q8_0_dense_d2r_available(int cc);
