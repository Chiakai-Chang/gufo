...
// ds4: was `static` in upstream. Exposed here so qfn_mmq.cu can call mmvq
...
// (above) directly through qfn_mmq.cu and never builds ggml_tensor structs.
...
#endif // DS4_MMVQ_INCLUDE_GGML_ENTRIES
