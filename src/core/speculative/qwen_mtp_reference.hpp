#ifndef STRIX_CORE_SPECULATIVE_QWEN_MTP_REFERENCE_HPP_
#define STRIX_CORE_SPECULATIVE_QWEN_MTP_REFERENCE_HPP_
...
#endif  // STRIX_CORE_SPECULATIVE_QWEN_MTP_REFERENCE_HPP_
